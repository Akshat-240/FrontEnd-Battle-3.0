...
export function FeaturesSection() {
  ...
  return (
    <section className="py-32 bg-background relative overflow-hidden" aria-labelledby="features-heading">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16" data-animate>
          <h2 id="features-heading" className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-foreground tracking-tight mb-4">
