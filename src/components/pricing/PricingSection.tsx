  ...
  useEffect(() => {
    function updatePrices() {
      ...
      if (btnMonthly && btnAnnual) {
        ...
        const activeClass = 'text-white shadow-sm'.split(' ');
      ...
      document.querySelectorAll<HTMLElement>('.currency-btn').forEach(btn => {
        ...
        if (c === curr) {
          ...
          btn.className = 'currency-btn px-3 py-1 text-sm font-medium rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forsythia bg-nocturnal text-white shadow-sm';
        } else {
