...
export function Footer() {
  return (
    <footer className="bg-oceanic text-arctic/80 pt-24 pb-12 relative overflow-hidden border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <span className="font-mono font-bold text-xl tracking-tight text-arctic">
          ...
          <div>
            <h3 className="font-mono font-semibold text-arctic mb-6">Product</h3>
          ...
          <div>
            <h3 className="font-mono font-semibold text-arctic mb-6">Company</h3>
            <ul className="space-y-4 text-sm">
          ...
          <div>
            <h3 className="font-mono font-semibold text-arctic mb-6">Legal</h3>
            <ul className="space-y-4 text-sm">
